...
#     print('========================')
#     pac_bound, p_opt, taus, new_emp_cost = optimize_PAC_bound(C, p0, delta)
#     print("McAllester PAC Bound:", pac_bound)
...
#     print('        Quad Opt        ')
#     print('========================')
#     quad_pac_bound, p_opt, new_emp_cost = optimize_quad_PAC_bound_bisection(C, p0, delta)
#     print("Quad PAC Bound:", quad_pac_bound)
#     print("New Emp Cost on Train Data:", new_emp_cost)
#     r = (np.sum(scipy.special.kl_div(p_opt, p0)) + np.log(2*np.sqrt(num_trials)/delta))/(2*num_trials)
#     print("R:",r)
