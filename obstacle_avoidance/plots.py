...
# [Class conditional success bound, Class condition failure bound, (class success loss, class success regularizer), (class failure loss, close failure regularizer))]
...
a = process_data(a)
a = [[0, 1, 0.016757644548097254, 1, None], *a, [1, 0, 1, 0.005634668729086153, None]]
# 1
# [1.0, 0.005634668729086153, (1.0489055587389169, 0.015997784012809116), (0.0, 0.004874808193798015)]
# [0.016757644548097254, 1.0, (0.0, 0.015997784012809116), (1.1467949564228181, 0.004874808193798015)]
...
b = process_data(b)
b = [[0, 1, 0.010765612583032677, 1, None], *b, [1, 0, 1, 0.011397144996587096, None]]
# 2
# [1.0, 0.011397144996587096, (1.0861375404960283, 0.010005752047744539), (0.0, 0.010637284461298958)]
# [0.010765612583032677, 1.0, (0.0, 0.010005752047744539), (1.0813800411765264, 0.010637284461298958)]

# arrays used for plotting based on computed bounds
print(a)
print(b)
